...
function Newarrival() {
  ...
  const url =
    `https://api.themoviedb.org/3/movie/now_playing?api_key=4144a92a014be96192b8e79b141493ea&language=en-US&page=${currentPage}`;
    ...
    <>
      ...
      <div className="grid lg:grid-cols-4 lg:ml-24 lg:mr-24 mt-16 lg:gap-y-16">
        ...
        <div className="flex space-x-72 w-full pb-10">
          ...
          gradientDuoTone="redToYellow">Next</Button>
        </div>
